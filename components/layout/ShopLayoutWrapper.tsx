  ...
  return (
    <AuthProvider>
      ...
      <a
        ...
        className={`md:hidden fixed bottom-20 right-5 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-lg bg-[#25D366] active:scale-95 transition-[transform,opacity] duration-200 ${anyPickerOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
      >
